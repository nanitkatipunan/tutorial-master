<template>
  <div id="card">
    <center>
      ...
      <hr>
      <div id="porm">
        <b-button block variant="primary" v-b-toggle.collapse-2 class="m-1">Add Course</b-button>
        <b-collapse id="collapse-2">
          <b-card>
            <b-form-group>
              ...
              <br>
              <b-button variant="success" @click="addItem">Add Subject</b-button>
            </b-form-group>
          </b-card>
        </b-collapse>
      </div>
      <div>
        <b-button block variant="success" v-b-toggle.collapse-2 class="m-1">Remove Course</b-button>
        <b-collapse id="collapse-2">
          <b-card>
            <b-form-group>
              <label id="course">Course:</label>
